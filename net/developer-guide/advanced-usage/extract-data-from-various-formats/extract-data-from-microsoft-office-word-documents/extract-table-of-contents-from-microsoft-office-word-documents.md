...
keywords: extract table of contents, extract TOC, Word document parsing, .doc, .docx
...
The [GetToc](https://reference.groupdocs.com/net/parser/groupdocs.parser/parser/methods/gettoc) method analyzes your Word document and identifies all headings formatted with built-in heading styles. It returns a structured collection of TOC items that you can navigate programmatically.
