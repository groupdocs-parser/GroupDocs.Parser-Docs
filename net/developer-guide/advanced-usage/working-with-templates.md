...
[TemplateTableParameters](https://reference.groupdocs.com/net/parser/groupdocs.parser.templates/templatetableparameters) class has the following constructors:
